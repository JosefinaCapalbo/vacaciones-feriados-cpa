...
const PASS = "admin123";
const MAX_DEF = 10;
const GCAL_CLIENT_ID = "969681315540-hnhe7pfqtc0u0tagaherjk3v3k2a1nu4.apps.googleusercontent.com";
...
export default function App(){
  ...
  return <div style={page}><div style={{maxWidth:680,margin:"0 auto"}}>
    ...
    <div style={{display:"flex",gap:6,marginBottom:14,flexWrap:"wrap"}}>{[["resumen","📊 Resumen"],["detalle","🔍 Detalle"],["gestion","⚙️ Gestión"]].map(([t,l])=><button key={t} onClick={()=>setAdminTab(t)} style={{background:adminTab===t?"#f7c5a8":CARD,border:"1px solid "+BDR,borderRadius:10,padding:"8px 14px",cursor:"pointer",fontWeight:adminTab===t?600:400,color:TXT,fontSize:14}}>{l}</button>)}</div>
